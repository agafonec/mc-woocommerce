...
/***/ "./assets/js/checkout-sms-subscription-block/block.js":
/*!************************************************************!*\
  !*** ./assets/js/checkout-sms-subscription-block/block.js ***!
  \************************************************************/
...
const Block = ({
  ...
  const [checked, setChecked] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(defaultChecked);
  const [smsPhone, setSmsPhone] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)('');
  const [phoneError, setPhoneError] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)('');
  const {
    setExtensionData
  } = checkoutExtensionData;

  // Get billing country from WooCommerce checkout store
  const billingCountry = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.useSelect)(select => {
  ...
  const isCountryEligible = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useCallback)(countryCode => {
  ...
  const validatePhone = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useCallback)(phone => {
    if (checked && !phone) {
      return (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Phone number is required for SMS consent.', 'mailchimp-for-woocommerce');
    }
    if (phone && !/^\+?[1-9]\d{6,14}$/.test(phone.replace(/[\s\-\(\)]/g, ''))) {
      return (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Please enter a valid phone number.', 'mailchimp-for-woocommerce');
    }
    return '';
  }, [checked]);
  ...
  // Default label text
  const labelText = text || (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Text me with news and offers', 'mailchimp-for-woocommerce');

  // Default disclaimer text with audience name placeholder
  const defaultDisclaimer = audienceName ? `${audienceName} – ` + (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('By providing your phone number, you agree to receive promotional and marketing messages, notifications, and customer service communications. Message & data rates may apply. Consent is not a condition of purchase. Message frequency may vary. You can unsubscribe at any time by replying STOP.', 'mailchimp-for-woocommerce') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('By providing your phone number, you agree to receive promotional and marketing messages, notifications, and customer service communications. Message & data rates may apply. Consent is not a condition of purchase. Message frequency may vary. You can unsubscribe at any time by replying STOP.', 'mailchimp-for-woocommerce');
  const disclaimer = smsDisclaimerText || defaultDisclaimer;
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("div", {
    className: "wc-block-components-checkout-step__container mailchimp-sms-consent",
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("div", {
      className: "wc-block-components-checkout-step__content",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_woocommerce_blocks_checkout__WEBPACK_IMPORTED_MODULE_1__.CheckboxControl, {
        id: "subscribe-to-sms",
        checked: checked,
        onChange: setChecked,
        ...
        className: "mailchimp-sms-phone-field",
        style: {
          marginTop: '12px',
          marginLeft: '28px'
        },
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_woocommerce_blocks_checkout__WEBPACK_IMPORTED_MODULE_1__.ValidatedTextInput, {
          id: "mailchimp-sms-phone",
          type: "tel",
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('SMS Phone Number', 'mailchimp-for-woocommerce'),
          value: smsPhone,
          onChange: handlePhoneChange,
          required: true,
          errorMessage: phoneError
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("p", {
          className: "mailchimp-sms-disclaimer",
          style: {
            fontSize: '12px',
            color: '#666',
            marginTop: '8px',
...
/***/ "./assets/js/checkout-sms-subscription-block/block.json":
/*!**************************************************************!*\
  !*** ./assets/js/checkout-sms-subscription-block/block.json ***!
  \**************************************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"apiVersion":2,"name":"woocommerce/mailchimp-sms-subscription","version":"1.0.0","title":"Mailchimp SMS Consent","category":"woocommerce","description":"Adds an SMS marketing consent checkbox and phone field to the checkout.","supports":{"html":true,"align":false,"multiple":false,"reusable":false},"parent":["woocommerce/checkout-contact-information-block"],"attributes":{"lock":{"type":"object","default":{"remove":true,"move":true}}},"textdomain":"mailchimp-woocommerce","editorStyle":"file:../../../build/style-sms-block.css"}');
...
/*!***************************************************************!*\
  !*** ./assets/js/checkout-sms-subscription-block/frontend.js ***!
  \***************************************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _block__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./block */ "./assets/js/checkout-sms-subscription-block/block.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./assets/js/checkout-sms-subscription-block/block.json");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! react/jsx-runtime */ "./node_modules/react/jsx-runtime.js");
/**
 * External dependencies
 */
...
const smsSettings = (0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_1__.getSetting)('mailchimp-sms_data', {});
...
(0,_woocommerce_blocks_checkout__WEBPACK_IMPORTED_MODULE_0__.registerCheckoutBlock)({
  ...
  component: props => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_block__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...props,
...
/******/ })()
;
//# sourceMappingURL=sms-block-frontend.js.map